# Contributing to KiCAD-365

First off, thanks for taking the time to contribute! 

The following is a set of guidelines for contributing to KiCAD-365. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
This section guides you through submitting a bug report for KiCAD-365.
...
This effort has majorly been vibe-coded by me over a sleepless weekend to solve a gripe I've had while working with a team of people on KiCAD projects. I've found the Live Server features of the "CAD that shan't be named" to actually be useful for reviewing and collaborating on PCB Designs. And this is a small effort to bridge the gap.
